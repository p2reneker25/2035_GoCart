...
public class Pneumatics extends SubsystemBase{
    ...
    public Pneumatics(){
        ...
        // left_gearbox = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, Constants.Pneumatics.PNEUMATICS_GEARBOX_LEFT_HI, Constants.Pneumatics.PNEUMATICS_GEARBOX_LEFT_LO);
        // right_gearbox = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, Constants.Pneumatics.PNEUMATICS_GEARBOX_RIGHT_HI, Constants.Pneumatics.PNEUMATICS_GEARBOX_RIGHT_LO);
    }
